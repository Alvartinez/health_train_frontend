...
@Component({
  selector: 'app-modal-module3',
  templateUrl: './modal-module3.component.html',
  styleUrls: ['./modal-module3.component.css']
})
export class ModalModule3Component {
  ...
  courses = [
    ...
    
    {
    ...
    
      {
        ...
        objetivo: "Al finalizar el módulo, el aprendiz reconocerá los establecimientos destinados a la fabricación, procesamiento, preparación, envase, almacenamiento, distribución, comercialización y expendio de alimentos deberán cumplir las condiciones generales en cuanto a edificaciones e instalaciones.",
        competencias: [
          "Aplica conocimientos y métodos actualizados de control e inocuidad de los alimentos, con responsabilidad, compromiso, precisión, con base a la normatividad vigente nacional, del INVIMA, ICONTEC, e INS:, Resolución 2674 de 2013, Resolución 0719 de 2015, Protocolo ETAS, Resolución 810 de 2021, Resolución 0714 de 2022, para desarrollar e interpretar resultados de análisis de los grupos de alimentos.",
